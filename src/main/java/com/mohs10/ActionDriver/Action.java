...
public class Action extends com.mohs10.base.StartBrowser {
	...
	public void navigateToApplication(String url) {
	    ...
	    String securityStatus = currentUrl.startsWith("https") ? "secure" : "not secure";
	    System.out.println("Current URL: " + currentUrl + " (" + securityStatus + ")");

	    String httpVersion = currentUrl.startsWith("http://") ? "HTTP" : "";
	    
	    String securityStatus1 = currentUrl.startsWith("https") ? "https" : "http";
	   
	    System.out.println("Security Status: " + securityStatus1);
	}
...
throw e;
	...
	/*
	 * public void filedownload() { // Set the download directory path String
	 * downloadDir = "path/to/download/directory";
	 * options.addArguments("--download.default_directory=" + downloadDir);
	 * 
	 * // Enable downloading PDF files instead of opening them in the browser
	 * options.addArguments("--plugins.always_open_pdf_externally=true");
	 * 
	 * // Create a DesiredCapabilities object with the ChromeOptions
	 * DesiredCapabilities capabilities = DesiredCapabilities.firefox;
	 * capabilities.setCapability(ChromeOptions.CAPABILITY, options);
	 * 
	 * // Launch the Chrome browser with the desired capabilities WebDriver driver =
	 * new ChromeDriver(capabilities);
	 * 
	 * // Open the webpage driver.get("http://example.com");
	 * 
	 * // Find and click the download button
	 * driver.findElement(By.id("downloadButton")).click();
	 * 
	 * // Sleep for a few seconds to allow the download to complete try {
	 * Thread.sleep(5000); } catch (InterruptedException e) { e.printStackTrace(); }
	 * 
	 * // Rename the downloaded file String originalFileName =
	 * "original_file_name.ext"; String newFileName = "new_file_name.ext"; String
	 * originalFilePath = downloadDir + "/" + originalFileName; String newFilePath =
	 * downloadDir + "/" + newFileName; renameFile(originalFilePath, newFilePath);
	 * 
	 * // Close the browser driver.quit(); }
	 */
private static void renameFile(String originalFilePath, String newFilePath) {
